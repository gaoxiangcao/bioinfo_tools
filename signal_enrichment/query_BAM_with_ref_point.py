...
if __name__ == '__main__':
    ...
    # load bed
    in_bed_file = open(ARGS.input, "rt")
    ...
    for region in in_bed_file:
        ...
        if region_list[5] == "+":
            ...
            upstream_extend_length = ARGS.up_extend_length
            downstream_extend_length = ARGS.down_extend_length
        else:
            ref_site = int(region_list[2])
            upstream_extend_length = ARGS.down_extend_length
            downstream_extend_length = ARGS.up_extend_length
        ...
        # upstream
        for up_region_start in range(ref_site_start - upstream_extend_length, ref_site_start, ARGS.extend_binsize):
            up_region_end = min(ref_site_end + upstream_extend_length, ref_site_start)
        ...
        # downstream
        for down_region_start in range(ref_site_end, ref_site_end + downstream_extend_length, ARGS.extend_binsize):
            down_region_end = min(down_region_start + ARGS.extend_binsize, ref_site_end + downstream_extend_length)
